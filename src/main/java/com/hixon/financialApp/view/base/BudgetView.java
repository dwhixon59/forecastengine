...
public abstract class BudgetView extends View implements BudgetViewInt
{
   ...
   public abstract void renderBudgetItem(BudgetItem budgetItem, double total);
   ...
   @Override
   public void renderSpendingReport(Calendar startDate) throws FileNotFoundException, UnsupportedEncodingException,
      ...
      while (rsbi.next()) {
         ...
         if (splits.size() > 0) {
            ...
            renderBudgetItem(budgetItem, total);
